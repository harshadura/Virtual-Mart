...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <table cellpadding="4" cellspacing="4" width="50%" align="center">
       ...
       <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Text="Bank Account Number:" ForeColor="Black" Width="200px"></asp:Label>
                <asp:TextBox ID="TextBoxBankAcc" runat="server" Width="250px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red"
                    Display="None" ControlToValidate="TextBoxBankAcc" ErrorMessage="Enter Bank Account Number">BankAccount</asp:RequiredFieldValidator>
            </td>
        </tr>
         <tr>
            <td>

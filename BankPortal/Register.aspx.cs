...
public partial class Register : System.Web.UI.Page
{
    ...
    protected void ButtonMakeProfile_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                DataSet1TableAdapters.LoginTableAdapter hb = new DataSet1TableAdapters.LoginTableAdapter();
                hb.InsertQuery(TextBoxUsername.Text, TextBoxPassword.Text, TextBoxEmail.Text, TextBoxBankAcc.Text, TextBoxCity.Text, TextBoxTP.Text);
